...
if __name__ == "__main__":
    ...
    igl0.load_state_dict(torch.load('./model_save/SEPv2_IGL_sg0_imp100'))
    ...
    igl2.load_state_dict(torch.load('./model_save/2SEP_IGL_sg2_imp002'))
    igl3 = IGL_large_sep(all_dim, robot_dim, 'cpu')
    igl3.load_state_dict(torch.load('./model_save/SEP_IGL_sg3_imp201'))
    ...
    while True:
        ...
        for i in range(1200):
            ...
            maintain.append(current_subgoal)
