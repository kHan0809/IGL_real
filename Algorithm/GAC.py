...
from Model.Model import QNetwork, GenerativeGaussianMLPActor, GenerativeGaussianMLPActor2, MLPQFunction
import itertools
import os
import time
...
class GAC(object):
    def __init__(self, state_dim, action_dim, args):
        ...
        self.q_optimizer = Adam(self.critic1.parameters(), lr=args.lr)
    ...
    def update_parameters(self, batch_size):
        ...
        with torch.no_grad():
            ...
            next_q_value = reward_batch + mask_batch * self.gamma * (qf1_next_target)
        ...
        loss_pi = -qf1_pi.mean() + self.log_alpha.exp() * mmd_entropy
        ...
        return qf1.mean().item(), qf1.mean().item(), qf_loss.item(),  loss_pi.item(), loss_log_alpha.exp().item()
