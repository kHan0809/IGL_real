...
from Model.Model import MLPQFunction_double, GenerativeGaussianMLPActor
...
class GAC(object):
    ...
    def update_parameters(self, batch_size):
        ...
        return qf1.mean().item(), qf2.mean().item(), qf_loss.item(),  loss_pi.item(), loss_log_alpha.exp().item(), self.log_alpha.exp().item(), self.beta
